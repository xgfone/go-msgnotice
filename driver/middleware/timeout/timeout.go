...
func New(_type string, priority int, timeout time.Duration) middleware.Middleware {
	...
	return middleware.NewMiddleware("timeout", _type, priority, func(d driver.Driver) driver.Driver {
		return driverImpl{Timeout: timeout, Driver: d}
	})
}
...
func (d driverImpl) Send(ctx context.Context, t, c string, md map[string]interface{}, tos ...string) error {
	ctx, cancel := context.WithTimeout(ctx, d.Timeout)
	defer cancel()
	return d.Driver.Send(ctx, t, c, md, tos...)
}
